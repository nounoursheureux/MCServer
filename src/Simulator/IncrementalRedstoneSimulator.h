...
#define MAX_POWER_LEVEL 15
	...
	public:
		...
		std::unordered_map<Vector3i, bool> m_SimulatedPlayerToggleableBlocks;
		std::unordered_map<Vector3i, sRepeatersDelayList> m_RepeatersDelayList;
	};
...
public:
	...
	typedef std::unordered_map<Vector3i, bool> SimulatedPlayerToggleableList;
	typedef std::unordered_map<Vector3i, sRepeatersDelayList> RepeatersDelayList;
